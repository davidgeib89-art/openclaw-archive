...
Current vector search finds *similar text* but fails to track *structural facts*.
*   Example: "Alice manages Auth."
*   Vector Search finds text about "Alice" and "Auth".
*   It does *not* know that `Alice` **IS_MANAGER_OF** `Auth`.
...
*   **Logic:**
    ...
    2.  *Prompt:* "Extract facts as (Entity, Relation, Entity) triples."
    3.  *Action:* `INSERT INTO semantic_relationships ...`
