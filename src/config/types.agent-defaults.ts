...
export type AgentDefaultsConfig = {
  ...
  heartbeat?: {
    ...
    accountId?: string;
    /** Override the heartbeat prompt body (default: "Read AGENDA.md if it exists (workspace context). If AGENDA.md is missing, read HEARTBEAT.md. Follow it strictly. Do not infer or repeat old agenda items from prior chats. If nothing needs attention, reply HEARTBEAT_OK."). */
    prompt?: string;
