...
export const icons = {
  ...
  heart: html`
    <svg viewBox="0 0 24 24">
      <path
        d="M12 20.8a1.8 1.8 0 0 1-1.2-.46C7.2 17.1 4 14.18 4 10.7A4.7 4.7 0 0 1 8.7 6a4.8 4.8 0 0 1 3.3 1.37A4.8 4.8 0 0 1 15.3 6 4.7 4.7 0 0 1 20 10.7c0 3.48-3.2 6.4-6.8 9.64a1.8 1.8 0 0 1-1.2.46Z"
      />
    </svg>
  `,
